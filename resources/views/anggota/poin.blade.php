...
@section('content')
    <div class="main-content-poin py-5">
        <div class="container-fluid px-3">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-11">
                    <div class="poin-area">
                        <h2 class="poin-header-title mb-4">Poin</h2>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-md-6 d-flex">
                                <div
                                    ...
                                    <img src="{{ asset('assets/images/logo badge.png') }}" alt="Badge Icon"
                                        class="badge-img mb-3" style="height:120px;">
                        ...
                        <div class="history-card bg-success-subtle p-4 rounded-3 shadow-sm">
                            ...
                            <div
                                class="xp-history-item border border-success rounded-3 p-3 d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/logo koin.png') }}" alt="XP Icon"
                                        class="xp-history-icon me-3">
                                    <div>
